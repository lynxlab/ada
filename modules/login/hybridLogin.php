...
try {
	...
	$hybridLogin = new Lynxlab\ADA\Module\Login\hybridLogin($loginProviderId);
	...
	if ($user_profile && isset($user_profile->identifier)) {
		...
		if (!is_object($userObj) || !$userObj instanceof ADALoggableUser) {
			 ...
			 */
			$userObj = $hybridLogin->addADAUser(
				$adaUser,
	...
	switch ($e->getCode()) {
		...
		case 1:
			...
			break;
		case 2:
			$message = "Provider di login non configurato bene.";
			break;
		case 3:
			$message = "Provider di login disabilitato o sconosciuto.";
			break;
		case 4:

...
// Trigger: ClassWithNameSpace. The class GdprRequestType was declared with namespace Lynxlab\ADA\Module\GDPR. //
...
class GdprRequestType extends GdprBase
{
     ...
     * @var string
     */
    public const TABLE =  AMAGdprDataHandler::PREFIX . 'requestTypes';

...
{
    public const POSTVARIABLE = 'multi';
    public const CLOZEDELIMITER = '§§§';
    public const HTMLDELIMITER = '~~~';
    public const SPANHEADER = '<span class="answer_multi_item_test">';
     ...
     * @see getPreparedText
     */
    public function buildDragDropElements(CElement $html, $preparedText, $showAnswers = false, $edit = false)
    {
    ...
    protected function getPreparedText($feedback = false, $rating = false, $rating_answer = false)
    {
        ...
        $html = preg_replace_callback($regexpWords, [$this,'addSpan'], $html);
        $html = preg_replace_callback($regexpRemoveHtmlPlaceholder, [$this,'removeHtmlPlaceholder'], $html);
        $html = preg_replace_callback($regexpImageHtml, [$this,'addSpan'], $html); //put a span around each image
    ...
    public function countSpanAndRemoveClozeMarker($params)
    {
        ...
        return $this->clozePlaceholder([$params[0],$ordine,$value]);
    }
            ...
            for ($j = 0; $j < $tableData['cols']; $j++,$y++) {
                ...
                if ($this->feedback) {
                    ...
                    foreach ($ordini as $order) {
                        ...
                        if (isset($this->exerciseWords[$order])) {
    ...
    protected function getTableData()
    {
        ...
        } elseif (!empty($this->titolo_dragdrop)) {

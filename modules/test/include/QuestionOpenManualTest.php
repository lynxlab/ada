...
// Trigger: ClassWithNameSpace. The class QuestionOpenManualTest was declared with namespace Lynxlab\ADA\Module\Test. //
    ...
    protected function renderingHtml(&$ref = null, $feedback = false, $rating = false, $rating_answer = false)
    {
        ...
        if ($feedback) {
            ...
            if ($_SESSION['sess_id_user_type'] == AMA_TYPE_TUTOR) {
                ...
                $div->addChild($span);
                $li->addChild($div);
            } elseif (!empty($this->givenAnswer['correzione_risposta'])) {

...
class QuestionFormTest extends FormTest
{
    ...
    public function __construct($id_test, $data = [], $id_nodo_parent = null, $isCloze = false, $savedExerciseType = false)
    {
    ...
    final protected function addTemplateEditor($id, $label)
    {
    ...
    protected function parentSelect()
    {
        ...
        $options = [ 0 => translateFN('Scegli un argomento')];

...
// Trigger: ClassWithNameSpace. The class QuestionMultipleCheckTest was declared with namespace Lynxlab\ADA\Module\Test. //
            ...
            while (!empty($_children)) {
                foreach ($_children as $k => $v) {
                    ...
                    if ($feedback) {
                        ...
                        if (
                            $this->givenAnswer['risposta'][self::POST_ANSWER_VAR]
                    ...
                    if ($v->extra_answer && $this->variation == ADA_NORMAL_TEST_VARIATION) {
                        ...
                        } elseif (!empty($post_data[self::POST_OTHER_VAR])) {

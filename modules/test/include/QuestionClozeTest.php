...
abstract class QuestionClozeTest extends QuestionTest
{
    ...
    public const REGEXPCLOZE = '#<cloze[^>]*title="([0-9]+)"[^>]*>(.*)</cloze>#mU';
    ...
    protected function getPreparedText($feedback = false, $rating = false, $rating_answer = false)
    {
        ...
        $preparedText = preg_replace_callback(self::REGEXPCLOZE, [$this, 'clozePlaceholder'], $this->replaceInternalLinkMedia($this->testo));

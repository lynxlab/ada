...
class TutorManagementTest
{
    ...
    public function __construct($what, Course $courseObj, CourseInstance $course_instanceObj, $id_student = null, $id_test = null, $id_history_test = null)
    {
        ...
        } elseif (!is_null($id_student) && !is_null($id_test)) {
            $this->action = 'list_history_tests';
        } elseif (!is_null($id_student)) {
    ...
    protected function listTests($student = false)
    {
        ...
        $params = ['id_corso' => $this->courseObj->id,'id_istanza_corso' => $this->course_instanceObj->id];
    ...
    protected function listHistoryTests($student = false)
    {
        ...
        $params = ['id_nodo' => $this->test['id_nodo'],'id_corso' => $this->courseObj->id,'id_istanza_corso' => $this->course_instanceObj->id];
        if ($student || $this->student) {
            $params['id_utente'] = $this->id_student;
        }
    ...
    public function run($returnHtml = false)
    {
        ...
        if ($returnHtml && is_a($return['html'], CBase::class)) {

...
define('MODULES_SLIDEIMPORT_NAME', join('', $moduledir->toArray()));
define('MODULES_SLIDEIMPORT_PATH', MODULES_DIR . DIRECTORY_SEPARATOR . $moduledir->getSource());
define('MODULES_SLIDEIMPORT_HTTP', HTTP_ROOT_DIR . str_replace(ROOT_DIR, '', MODULES_DIR) . '/' . $moduledir->getSource());
/**

...
// Trigger: ClassWithNameSpace. The class BadgesAbstractForm was declared with namespace Lynxlab\ADA\Module\Badges. //
...
abstract class BadgesAbstractForm extends FForm
{
    private $withSubmit;
    private $isReadOnly;

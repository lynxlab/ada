...
// Trigger: ClassWithNameSpace. The class CourseBadgeForm was declared with namespace Lynxlab\ADA\Module\Badges. //
...
{
    public function __construct(array $badges, array $conditionSets, $formName = null, $action = null, $courseId = null)
    {
        ...
        if (!is_null($courseId)) {
            $this->addHidden('id_corso')->withData($courseId);
        }

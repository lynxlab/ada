...
// Trigger: ClassWithNameSpace. The class BadgesActions was declared with namespace Lynxlab\ADA\Module\Badges. //
...
class BadgesActions
{
     ...
     * @var integer
     */
    public const NEW_BADGE = 1;
    public const EDIT_BADGE = 2;
    public const TRASH_BADGE = 3;

    public const BADGE_COURSE_LINK = 4;
    public const BADGE_COURSE_TRASH = 5;

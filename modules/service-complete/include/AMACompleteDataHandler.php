                ...
                while (!empty($toSave) && ($loopCounter-- >= 0)) {
                    foreach ($toSave as $key => $currentOperation) {
                        ...
                        if (!$op1Pointer && !$op2Pointer) {
                            ...
                            $processed = 1;
                        } elseif ($op1Pointer && !$op2Pointer && isset($mappedIDs[$op1Pointer])) {
                            ...
                            $processed = 2;
                        } elseif (!$op1Pointer && $op2Pointer && isset($mappedIDs[$op2Pointer])) {
                            ...
                            $processed = 3;
                        } elseif ($op1Pointer && $op2Pointer && isset($mappedIDs[$op1Pointer]) && isset($mappedIDs[$op2Pointer])) {
                        ...
                        if ($processed == 2 || $processed == 4) {
                            $saveData[2] = 'expr(' . $operand1 . ')';
                        }
                        if ($processed == 3 || $processed == 4) {
                            $saveData[3] = 'expr(' . $operand2 . ')';
                        }

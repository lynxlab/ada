...
// Trigger: ClassWithNameSpace. The class StudentsGroupsAbstractForm was declared with namespace Lynxlab\ADA\Module\StudentsGroups. //
 ...
 *
 */
abstract class StudentsGroupsAbstractForm extends FForm
{
    private $withSubmit;
    private $isReadOnly;

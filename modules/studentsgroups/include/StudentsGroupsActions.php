...
class StudentsGroupsActions
{
    ...
    public const EDIT_GROUP = 2;
    public const TRASH_GROUP = 3;
     ...
     * typical usage is: list($allowedUsersAr, $neededObjAr) = array_values(StudentsGroupsActions::getAllowedAndNeededAr());
     *
    ...
    public static function getAllowedAndNeededAr($fileName = null)
    {
        ...
        $fileName = trim(str_replace(MODULES_STUDENTSGROUPS_PATH, '', $fileName), '/');

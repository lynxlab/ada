...
if (defined('AMA_TYPE_STUDENT')) {
    echo 'const AMA_TYPE_STUDENT = ' . AMA_TYPE_STUDENT.';' .PHP_EOL;
}
if (defined('AMA_TYPE_TUTOR')) {
    echo 'const AMA_TYPE_TUTOR = ' . AMA_TYPE_TUTOR.';' .PHP_EOL;
}
if (defined('AMA_TYPE_SWITCHER')) {
    echo 'const AMA_TYPE_SWITCHER = ' . AMA_TYPE_SWITCHER.';' .PHP_EOL;
}

...
class NotificationActions
{
     ...
     * @var integer
     */
    public const ADDNOTIFICATION = 1;
    public const DELNOTIFICATION = 2;
     ...
     * typical usage is: list($allowedUsersAr, $neededObjAr) = array_values(NotificationActions::getAllowedAndNeededAr());
     *
    ...
    public static function getAllowedAndNeededAr($fileName = null)
    {
        ...
        $fileName = trim(str_replace([MODULES_NOTIFICATIONS_PATH, ROOT_DIR], '', $fileName), '/');
        if (strlen($fileName) > 0) {
            ...
            switch ($fileName) {
                case 'ajax/saveNotification.php':
                    $retArr['neededObjects'] = [
                        AMA_TYPE_SWITCHER => ['layout'],
                        AMA_TYPE_TUTOR => ['layout'],
                        AMA_TYPE_SUPERTUTOR => ['layout'],

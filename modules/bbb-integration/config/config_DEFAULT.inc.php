...
try {
    if (! @include_once(MODULES_BIGBLUEBUTTON_PATH . '/vendor/autoload.php')) {
        // @ - to suppress warnings,
        throw new Exception(
            json_encode([
                'header' => 'BigBlueButton module will not work because autoload file cannot be found!',
        ...
        /**
         * NOTE
         * BBB_SERVER, BBB_SERVER_BASE_URL and BBB_SECRET must be defined in:

...
class FCKeditor
{
    ...
    public function isCompatible()
    {
        ...
        if (str_contains($sAgent, 'MSIE') && !str_contains($sAgent, 'mac') && !str_contains($sAgent, 'Opera')) {
            $iVersion = (float)substr($sAgent, strpos($sAgent, 'MSIE') + 5, 3);
            return ($iVersion >= 5.5);
        } elseif (str_contains($sAgent, 'Gecko/')) {
            // Firefox 17+
        ...
        } elseif (str_contains($sAgent, 'Opera/')) {

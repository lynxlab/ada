...
class ADAEvent
{
    ...
    public static function parseMessageText($message_ha = [])
    {
    ...
    private static function extractActionFromEventMessage($message_ha = [])
    {
    ...
    private static function createTheEnterLink($message_ha = [])
    {

...
require_once Widget::ADA_WIDGET_AJAX_ROOTDIR . '/include/TwitterAccess.inc.php';

if (!isset($screen_name)) {
    die('no twitter timeline to load');
}
...
if (!isset($circularImage) || !is_numeric($circularImage)) {
    $circularImage = 0;
}
...
$searchForBuildURL =  ['<URL>','<EXPANDED_URL>','<DISPLAY_URL>'];

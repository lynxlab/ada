...
$GLOBALS['reportHTMLColArray'] = [ 'REPORT_COLUMN_EXERCISES', 'REPORT_COLUMN_BOOKMARKS', 'REPORT_COLUMN_TIME_IN_COURSE' ];
$GLOBALS['reportFILEColArray'] = [ 'REPORT_COLUMN_EXERCISES', 'REPORT_COLUMN_BOOKMARKS', 'REPORT_COLUMN_TIME_IN_COURSE','REPORT_COLUMN_LEVEL_PLUS', 'REPORT_COLUMN_LEVEL_LESS' ];

...
$GLOBALS['LogReport_Array'] = [
    'provider' => ['label' => 'provider','show' => true],
    'final_users' => ['label' => 'utenti registrati','show' => true],
    'user_subscribed' => ['label' => 'utenti iscritti','show' => true],
    'course' => ['label' => 'tot. corsi','show' => true],
    'service_level' => ['label' => 'service_level','show' => true],  // if true show course types.
    'sessions_started' => ['label' => 'ed. in corso','show' => true],
    ...
    'sessions_closed' => ['label' => 'ed. chiuse','show' => true],
    ...
    'tot_Session' => ['label' => 'tot. edizioni','show' => true],

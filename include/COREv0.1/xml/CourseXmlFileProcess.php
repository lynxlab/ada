...
class course_xml_file_process
{
    ...
    public $file = "";  // xml data file
    public $currentTag = ""; // utilizzato per tener traccia del tag in processo
    public $parser;
    public $livello = 0;
    public $livellolink = 0;
    public $livellomedia = 0;
    public $totale_nodi = 0;
    public $initerror = "";
    public $dati_nodo_ar = [];
    public $dati_media_ar = [];
    public $file_no_copy = [];
    public $set_ha = [];

    public $error = [""]; // array errori

    public $str = ""; // per debug
        ...
        switch ($name) {
            case "NODE":
                ...
                */
                ...
                @$this->dati_nodo_ar[$this->livello]['MEDIA'] = [];

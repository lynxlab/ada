...
{
    public static function registrationForm($form_dataAr = [], $errorsAr = [])
    {
        ...
        $genderAr = ['0' => translateFN('Scegli un genere'),'M' => translateFN('maschio'),'F' => translateFN('femmina')];
        ...
        $provinceAr = [translateFN('Scegli una provincia')];

...
class BaseHtmlLib
{
    ...
    public static function selectElement($element_attributes = '', $data = [])
    {
    ...
    public static function selectElement2($element_attributes = '', $data = [], $selected = null)
    {
        $select = CDOMElement::create('select', $element_attributes);
    ...
    public static function radioButtons($element_attributes = '', $data = [], $radio_name = '')
    {
    ...
    public static function checkBox($element_attributes = '', $data = [], $check_name = '')
    {
    ...
    public static function plainListElement($element_attributes = '', $data = [], $WithLabel = true)
    {
    ...
    public static function labeledListElement($element_attributes = '', $data = [])
    {
    ...
    public static function tableElement($element_attributes = '', $thead_data = [], $tbody_data = [], $tfoot_data = [], $caption = '')
    {
        ...
        foreach ($tbody_data as $table_row) {
            ...
            foreach ($table_row as $column_in_row) {
                ...
                if ($parityCol % 2 == 0) {
                    if (isset($css_even_td_class)) {
                        $column->setAttribute('class', "$css_even_td_class");
                    }
                } else {
                    if (isset($css_odd_td_class)) {

...
class UserModuleHtmlLib
{
     ...
     */
    public static function loginRegistrationForm($supported_languages = [], $login_page_language_code = null, $login_error_message = '', $id_course = null)
    {
     ...
     */
    public static function translationSearchForm($supported_languages = [])
    {
    ...
    public static function translationSelectSupportedLanguages($container, $supported_languages = [])
    {
     ...
     */
    public static function translationImportSystemMessagesForm($form_action, $supported_languages = [])
    {
    ...
    public static function translationFoundMessagesHtmlList($found_messages = [], $language_code = '', $container_id = null, $translation_search_text = '')
    {
    ...
    public static function getEditPractitionerForm($user_dataAr = [], $errorsAr = [])
    {
        return self::getEditUserForm('edit_tutor.php', $user_dataAr, $errorsAr);
    }

    public static function getEditSwitcherForm($user_dataAr = [], $errorsAr = [])
    {
        return self::getEditUserForm('edit_switcher.php', $user_dataAr, $errorsAr);
    }

    public static function getEditAuthorForm($user_dataAr = [], $errorsAr = [])
    {
        return self::getEditUserForm('edit_author.php', $user_dataAr, $errorsAr);
    }

    private static function getEditUserForm($action, $user_dataAr = [], $errorsAr = [])
    {

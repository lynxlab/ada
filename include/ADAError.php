...
class ADA_Error
{
    ...
    public function __construct($AMAErrorObject = null, $errorMessage = null, $callerName = null, $ADAErrorCode = null, $severity = null, $redirectTo = null, $delayErrorHandling = false)
    {
        ...
        $this->errorCode      = 0;
        $this->getFileAndLine();
        $this->sessUserId           = $_SESSION['sess_id_user'] ?? 'NONE';
        $this->sessCourseId         = $_SESSION['sess_id_course'] ?? 'NONE';
        $this->sessCourseInstanceId = $_SESSION['sess_id_course_instance'] ?? 'NONE';
        $this->sessNodeId           = $_SESSION['sess_id_node'] ?? 'NONE';

...
use Lynxlab\ADA\Main\User\Competences;
...
// Trigger: ClassWithNameSpace. The class Competences was declared with namespace Lynxlab\ADA\Main\User. //
...
class Competences extends UserExtraTables
{
    public $idCompetence;
     ...
     * @var string
     */
    protected static $keyProperty = "idCompetence";
    ...
    public function __construct($dataAr = [])
    {
        $this->labels = [
            null,
            null,
            translateFN('experience in techmology'),
            translateFN('year of experience'),
        ];

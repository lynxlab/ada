...
class AMAPDOWrapper
{
     ...
     * @access public
     */
    public function &getAll($query, $params = [], $fetchmode = null, $col = null)
    {
        /**
     ...
     * @access public
     */
    public function &getAssoc($query, $force_array = false, $params = [], $fetchmode = null, $group = false)
    {
     ...
     * @access public
     */
    public function &getRow($query, $params = [], $fetchmode = null)
    {
        /**
         * if $params is a scalar, let's transform it into a one-element array
         */

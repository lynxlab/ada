...
class FontProp
{
    public $font_family = FONT1;
    public $font_style = FS_NORMAL;
    public $font_size = 14;
    public $font_color = [0,0,0];
    public function SetFont($family, $style = FS_NORMAL, $size = 14)
    {
...
class SpiderAxis extends Axis
{
    ...
    //---------------
    // CONSTRUCTOR
    public function SpiderAxis(&$img, &$aScale, $color = [0,0,0])
    {
    ...
    public function Stroke($pos, $a, &$grid, $title, $lf)
    {
...
class SpiderPlot
{
    ...
    //---------------
    // CONSTRUCTOR
    public function SpiderPlot($data)
    {
        $this->data = $data;
    }
    ...
    public function SetColor($color, $fill_color = [160,170,180])
    {
        $this->color = $color;
...
class SpiderGraph extends Graph
{
    ...
    //---------------
    // CONSTRUCTOR
    public function SpiderGraph($width = 300, $height = 200, $cachedName = "")
    {

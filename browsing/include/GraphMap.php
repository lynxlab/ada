...
class GraphMap
{
    public static function makeImageMapFN($children_ha, $user_level, $id_profile)
    {
    ...
    */
    ...
    public static function computeMaxFN($children_ha)
    {
        $max_X = 0;
        $max_Y = 0;
    ...
    /*-------------------------------------------------------------------------*/
    public static function copyImageFN($children_ha, $im_dest, $max_X, $max_Y, $user_level)
    {
    ...
    public static function makeLinkFN($children_ha, $im_dest, $position_node)
    {
        $background_R = $GLOBALS['background_R'];
        $background_G = $GLOBALS['background_G'];
        $background_B = $GLOBALS['background_B'];
    ...
    public static function showImageFN($im_dest)
    {
